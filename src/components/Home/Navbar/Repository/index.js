                        ...
                        <div style={{ maxHeight: '78vh', overflowY: 'auto' }}>
                            <ul className="space-y-4">
                                {favorites.map((favorite) => (
                                    <li key={favorite.postsID} className="border bg-gray-100 rounded-lg overflow-hidden relative">
                                        <div className="p-2 pl-6 bg-gray-200 flex items-center justify-between">
                                        ...
                                        <div className="px-4 py-2 border-t">
                                            ...
                                            <div className='flex justify-between mt-4 ml-4 mr-4'>
                                                <p className="text-sm text-red-500 flex">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512 " strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-1">
